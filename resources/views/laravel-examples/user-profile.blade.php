...
<div>
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/curved-images/gh2.jpg'); background-position-y: 65%;">
            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../assets/img/blank_pict.png" alt="..." class="w-100 border-radius-lg shadow-sm">
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <!-- @foreach ($users as $key => auth()-> $user)
                            {{auth()->user()->name}}
                        @endforeach -->
                        </h5>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="/users?view=user-profile" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
