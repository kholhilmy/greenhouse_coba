...
$(document).ready(function(){
  ...
  <div class="row mt-5">
            <h5 class="font-weight-bolder mb-3">{{ $greenhouse->nama_greenhouse }}</h5>
                ...
                <div class="card z-index-2">
                    <div class="card-body p-3">
                        <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                            <div class="chart">
                                <canvas id="chart-bars-{{ $greenhouse->id_greenhouse }}" class="chart-canvas" height="170"></canvas>
                            </div>
                        </div>
                        <h6 class="ms-2 mt-4 mb-0">Statistik Data PH (Greenhouse: {{ $greenhouse->id_greenhouse }})</h6>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 mb-lg-0 mb-4">
                <div class="card z-index-2">
                    <div class="card-body p-3">
                        <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                            <div class="chart">
                                <canvas id="chart-light-{{ $greenhouse->id_greenhouse }}" class="chart-canvas" height="170"></canvas>
                            </div>
                        </div>
            ...
            <div class="col-lg-7">
                <div class="card z-index-2">
                    <div class="card-header pb-0">
                        <h6>Statistik Data Nutrisi dan Ketinggian Air</h6>
                    </div>
                    <div class="card-body p-3">
                        <div class="chart">
            ...
            <div class="row">
              <div class="col-3 py-3 ps-0">
                <div class="d-flex mb-2">
                  ...
                  <p class="text-xs mt-1 mb-0 font-weight-bold">Data Terakhir</p>
                </div>
    ...
    <div class="col-lg-5 mb-lg-0 mb-4">
      <div class="card z-index-2">
        <div class="card-body p-3">
          ...
          <h6 class="ms-2 mt-4 mb-0"> Statistik Data Air </h6>
          <p class="text-sm ms-2"><span class="font-weight-bolder"></span></p>
          <div class="container border-radius-lg">
            <div class="row">
              <div class="col-3 py-3 ps-0">
