...
<div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Create Plant') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{ route('jenis_tanaman.store') }}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('nama_jenis')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ old('nama_jenis') }}" type="text" id="nama_jenis" name="nama_jenis">
                                        @error('nama_jenis')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('tmax_ph')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="tmax_ph" name="tmax_ph" value="{{ old('tmax_ph') }}">
                                        @error('tmax_ph')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('tmin_ph')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="tmin_ph" name="tmin_ph" value="{{ old('tmin_ph') }}">
                                        @error('tmin_ph')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('t_suhu')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="t_suhu" name="t_suhu" value="{{ old('t_suhu') }}">
                                        @error('t_suhu')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('t_cahaya')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="t_cahaya" name="t_cahaya" value="{{ old('t_cahaya') }}">
                                        @error('t_cahaya')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('t_kelembapan')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="t_kelembapan" name="t_kelembapan" value="{{ old('t_kelembapan') }}">
                                        @error('t_kelembapan')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('tmax_ketinggian')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="tmax_ketinggian" name="tmax_ketinggian" value="{{ old('tmax_ketinggian') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('tmin_ketinggian')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="tmin_ketinggian" name="tmin_ketinggian" value="{{ old('tmin_ketinggian') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('tmax_tds')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="tmax_tds" name="tmax_tds" value="{{ old('tmax_tds') }}">
                                        @error('tmax_tds')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('tmin_tds')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="" id="tmin_tds" name="tmin_tds" value="{{ old('tmin_tds') }}">
                                        @error('tmin_tds')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
